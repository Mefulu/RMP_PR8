package com.example.myapplication_pr8.DATA.DataSources;

import android.content.Context;
import androidx.lifecycle.LiveData;
import androidx.room.Room;
import com.example.myapplication_pr8.DATA.DataSources.Files.AppSpecificDataSources;
import com.example.myapplication_pr8.DATA.DataSources.Files.CommonFileDataSources;
import com.example.myapplication_pr8.DATA.DataSources.Room.AppDatabase;
...
import com.example.myapplication_pr8.DATA.DataSources.SharedPreferences.SharedPreferencesDS;
...
public class Repository {
    ...
    public void insertCategory(String itemName, int img) {
        ...
        category.itemsName = itemName;
        category.img = img;
        database.listDAO().insertCategory(category);
    }
}
